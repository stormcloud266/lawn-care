  ...
  <Layout>
    ...
    <section className="intro section wrapper">
      ...
      <div className="intro__text text">
        ...
        <ul>
          <li><FontAwesomeIcon icon={['far', 'check-circle']} />Get professional results</li>
          <li><FontAwesomeIcon icon={['far', 'check-circle']} />Save your time</li>
          <li><FontAwesomeIcon icon={['far', 'check-circle']} />Enjoy your summer</li>
        </ul>
      </div>
